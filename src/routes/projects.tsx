...
const projects = [
  { img: photos.twilight, title: "House at twilight", place: "Taupō", note: "Full new-build, layered exterior lighting." },
  { img: photos.fountainEntry, title: "Fountain entry", place: "Taupō", note: "Approach and entry lighting design." },
  { img: photos.kitchen, title: "Kitchen", place: "Taupō", note: "Joinery-integrated lighting and switching." },
  { img: photos.living, title: "Living room", place: "Kinloch", note: "Layered ambient & feature lighting." },
  { img: photos.img0003, title: "Hall study", place: "Taupō", note: "Reading light, charging detail." },
  { img: photos.img0004, title: "Quiet bedroom", place: "Taupō", note: "Bedside circuits, blackout integration." },
  { img: photos.img0004b, title: "Bedroom detail", place: "Taupō", note: "Switching at hand height, in walnut." },
  { img: photos.img0005, title: "Pantry", place: "Taupō", note: "Concealed strip in shadow-line." },
  { img: photos.img0006, title: "Pendant rhythm", place: "Taupō", note: "Three pendants over stone." },
  { img: photos.img0011jpeg, title: "Bathroom", place: "Taupō", note: "IP-rated layered scheme." },
  { img: photos.img0011, title: "Stair", place: "Taupō", note: "Tread-level wash, dimmed after 10pm." },
  { img: photos.img0419, title: "Detail", place: "Taupō district", note: "Brass plate, tight tolerances." },
];
