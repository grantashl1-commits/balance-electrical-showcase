    ...
    <SiteLayout>
      ...
      <section className="relative w-full h-[50vh] min-h-[400px] overflow-hidden spotlight-amber">
        <img
          ...
          style={{ opacity: 0.3 }}
        />
        <div className="absolute inset-0 spotlight-amber" style={{ background: "radial-gradient(ellipse at 50% 50%, rgba(138, 144, 112,0.18) 0%, transparent 65%), #3A3E30", opacity: 0.85 }} />
        <div className="relative z-10 mx-auto max-w-7xl px-6 h-full flex flex-col justify-end pb-20">
          <p
            className="reveal text-[10px] uppercase tracking-[0.2em] text-[#8A9070] mb-4 font-sans"
          ...
          <div className="relative flex items-start">
            ...
            <div className="pl-8 md:pl-12 reveal">
              <img
                ...
                style={{
                  boxShadow: "0 0 80px rgba(138, 144, 112,0.25), 0 0 160px rgba(138, 144, 112,0.08)",
                  border: "1px solid rgba(138, 144, 112,0.15)",
          ...
          <div className="relative mt-12 md:mt-0">
            ...
            <div className="pl-8 md:pl-12 space-y-8">
              <div className="reveal" data-delay="80">
                <p
                  className="text-[9px] uppercase tracking-[0.25em] text-[#8A9070] mb-4"
                  style={{ fontFamily: "Inter, ui-sans-serif, system-ui, sans-serif" }}
                >
              ...
              <div className="reveal space-y-5 text-[15px] leading-relaxed" data-delay="160">
                <p className="text-[#C4C0B4]" style={{ fontFamily: "Inter, ui-sans-serif, system-ui, sans-serif" }}>
              ...
              <div className="reveal pt-2" data-delay="240">
                ...
                >
                  ...
                  />
                  <span
                    className="text-[13px] text-[#C4C0B4]"
                    style={{ fontFamily: "Inter, ui-sans-serif, system-ui, sans-serif" }}
                  >
      ...
      {/* VALUES */}
      <section className="bg-[#424636]">
        <div className="led-strip-h" />
        <div className="mx-auto max-w-7xl px-6 py-24 md:py-32">
          <div className="text-center reveal mb-16">
            <p
              className="text-[10px] uppercase tracking-[0.2em] text-[#8A9070] mb-4"
              style={{ fontFamily: "Inter, ui-sans-serif, system-ui, sans-serif" }}
            >
              WHAT WE STAND FOR
            </p>
          ...
          <div className="grid md:grid-cols-3 gap-0">
            ...
            <div className="relative px-8 py-10 reveal" data-delay="0">
              <div className="relative z-10">
                ...
                <h3 className="font-display text-2xl md:text-3xl text-[#F5F2EC] mt-4 mb-4">
                  Integrity
                </h3>
                <p
      ...
      <section className="relative spotlight-amber">
        ...
        <div className="mx-auto max-w-7xl px-6 py-24 md:py-32 grid md:grid-cols-2 gap-14 items-center">
          <div className="reveal" data-delay="0">
            ...
            <p
              className="text-[#C4C0B4] text-lg leading-relaxed mb-8"
              style={{ fontFamily: "Inter, ui-sans-serif, system-ui, sans-serif" }}
            >
          ...
          <div className="reveal space-y-6" data-delay="100">
            ...
            >
              <Phone className="w-6 h-6 text-[#8A9070]" />
              <span
                className="font-display text-[28px] text-[#F5F2EC] group-hover:text-[#8A9070] transition-colors"
            ...
            <a
              ...
              className="block text-[14px] text-[#8A9070] hover:underline"
              style={{ fontFamily: "Inter, ui-sans-serif, system-ui, sans-serif" }}
            >
